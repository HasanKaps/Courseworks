...
public class Responder
{
    ...
    public Responder()
    {
        ...
        previousIndex=responseMap.size();
        
    }

    private void SynonymResponse()
    {
    ...
    {
       String response = null;                 //set response generated to null
